...
static bfd_reloc_status_type nios2_elf32_hi20_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);

static bfd_reloc_status_type nios2_elf32_lo12_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);

static bfd_reloc_status_type nios2_elf32_hiadj20_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
...
static bfd_reloc_status_type nios2_elf32_pcrel14_s2_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
...
static bfd_reloc_status_type nios2_elf32_do_hi20_relocate
  (bfd *, reloc_howto_type *, asection *,
	 bfd_byte *, bfd_vma, bfd_vma, bfd_vma);

static bfd_reloc_status_type nios2_elf32_do_lo12_relocate
  (bfd *, reloc_howto_type *, asection *,
	 bfd_byte *, bfd_vma, bfd_vma, bfd_vma);

static bfd_reloc_status_type nios2_elf32_do_hiadj20_relocate
  (bfd *, reloc_howto_type *, asection *,
	 bfd_byte *, bfd_vma, bfd_vma, bfd_vma);
...
static bfd_reloc_status_type nios2_elf32_do_pcrel14_s2_relocate
  (bfd *, reloc_howto_type *, asection *,
         bfd_byte *, bfd_vma, bfd_vma, bfd_vma);
...
/* Target vector.  */
extern const bfd_target bfd_elf32_littlenios2dpx_vec;
extern const bfd_target bfd_elf32_bignios2dpx_vec;
...
static reloc_howto_type elf_nios2_howto_table_rel[] = {
  ...
  HOWTO (R_NIOS2_S16,		/* type */
	 ...
	 "R_NIOS2_S16",		/* name */
	 FALSE,			/* partial_inplace */
	 OP_MASK_IMM16,		/* src_mask */
	 OP_MASK_IMM16,		/* dest_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* ToDo: JDS -> This one needs to be fixed */
  HOWTO (R_NIOS2_CALL26,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 28,			/* bitsize */
	 FALSE,			/* pc_relative */
	 OP_SH_IMM26LO,			/* bitpos */
	 complain_overflow_dont,	/* complain on overflow */
	 nios2_elf32_call26_relocate,	/* special function */
	 "R_NIOS2_CALL26",	/* name */
	 FALSE,			/* partial_inplace */
	 (OP_MASK_IMM26LO | OP_MASK_IMM26HI), /* src_mask */
	 (OP_MASK_IMM26LO | OP_MASK_IMM26HI), /* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* R_NIOS2_CACHE_OPX is a nop for dpx */
  ...
  /* 12-bit signed immediate relocation */
  HOWTO (R_NIOS2_S12,		/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 "R_NIOS2_S12",		/* name */
	 FALSE,			/* partial_inplace */
	 OP_MASK_IMM12,		/* src_mask */
	 OP_MASK_IMM12,		/* dest_mask */
	 FALSE),		/* pcrel_offset */

  /* 12-bit unsigned immediate relocation */
  HOWTO (R_NIOS2_U12,		/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
  ...
  HOWTO (R_NIOS2_BMX_LSB,		/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 OP_BMX_LSB_IMM5_SIZE,			/* bitsize */
	 FALSE,			/* pc_relative */
	 OP_SH_BMX_LSB_IMM5,	       	/* bitpos */
	 complain_overflow_unsigned,	/* complain on overflow */
	 bfd_elf_generic_reloc,	/* special function */
	 "R_NIOS2_BMX_LSB",		/* name */
	 FALSE,			/* partial_inplace */
	 OP_MASK_BMX_LSB_IMM5,		/* src_mask */
	 OP_MASK_BMX_LSB_IMM5,		/* dest_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_NIOS2_BMX_MSB,		/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 OP_BMX_MSB_IMM5_SIZE,			/* bitsize */
	 FALSE,			/* pc_relative */
	 OP_SH_BMX_MSB_IMM5,	       	/* bitpos */
	 complain_overflow_unsigned,	/* complain on overflow */
	 bfd_elf_generic_reloc,	/* special function */
	 "R_NIOS2_BMX_MSB",		/* name */
	 FALSE,			/* partial_inplace */
	 OP_MASK_BMX_MSB_IMM5,		/* src_mask */
	 OP_MASK_BMX_MSB_IMM5,		/* dest_mask */
	 FALSE),		/* pcrel_offset */


  HOWTO (R_NIOS2_PCREL14_S2,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 TRUE,			/* pc_relative */
	 OP_SH_IMM12,	       	/* bitpos */
	 complain_overflow_signed, /* complain on overflow */
	 nios2_elf32_pcrel14_s2_relocate,	/* special function */
	 "R_NIOS2_PCREL14_S2",	/* name */
	 FALSE,			/* partial_inplace */
	 OP_MASK_IMM12,		/* src_mask */
	 OP_MASK_IMM12,		/* dest_mask */
	 TRUE),			/* pcrel_offset */
  ...
  HOWTO (R_NIOS2_U20,		/* type */
	 ...
	 "R_NIOS2_U20",		/* name */
	 FALSE,			/* partial_inplace */
	 OP_MASK_IMM20,		/* src_mask */
	 OP_MASK_IMM20,		/* dest_mask */
	 FALSE),		/* pcrel_offset */
...
static const struct elf_reloc_map nios2_reloc_map[] = {
  ...
  {BFD_RELOC_NIOS2_S12, R_NIOS2_S12},
  {BFD_RELOC_NIOS2_U12, R_NIOS2_U12},
  {BFD_RELOC_NIOS2_BMX_LSB, R_NIOS2_BMX_LSB},
  {BFD_RELOC_NIOS2_BMX_MSB, R_NIOS2_BMX_MSB},
  {BFD_RELOC_NIOS2_14_PCREL_S2, R_NIOS2_PCREL14_S2},
  {BFD_RELOC_NIOS2_U20, R_NIOS2_U20},
  {BFD_RELOC_NIOS2_HI20, R_NIOS2_HI20},
  {BFD_RELOC_NIOS2_LO12, R_NIOS2_LO12},
  {BFD_RELOC_NIOS2_HIADJ20, R_NIOS2_HIADJ20},
};
...
static bfd_boolean
nios2_elf_merge_private_bfd_data (bfd * ibfd, bfd * obfd)
{
  flagword old_flags;
  flagword new_flags;
...
static void
nios2_final_write_processing (bfd *abfd,
                              bfd_boolean linker ATTRIBUTE_UNUSED)
{
  elf_elfheader (abfd)->e_flags &= ~(EF_NIOS2_ARCH);
  elf_elfheader (abfd)->e_flags |= E_NIOS2_ARCH_DPX;

  elf_elfheader (abfd)->e_flags &= ~(EF_NIOS2_ENCODE);
  elf_elfheader (abfd)->e_flags |= E_NIOS2_ENCODE_6B;
}
...
#define OP_MATCH_NOP 0x30000031
...
static bfd_reloc_status_type
nios2_elf32_hi20_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			   void *data, asection *input_section,
			   bfd *output_bfd,
			   char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_elf32_do_hi20_relocate (abfd, reloc_entry->howto,
				       input_section,
				       data, reloc_entry->address,
				       (symbol->value
					+ symbol->section->output_section->vma
...
static bfd_reloc_status_type
nios2_elf32_lo12_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
                           void *data, asection *input_section,
			   bfd *output_bfd,
			   char **error_message ATTRIBUTE_UNUSED)
{
/* This part is from bfd_elf_generic_reloc.  */
  ...
  return nios2_elf32_do_lo12_relocate (abfd, reloc_entry->howto,
				       input_section,
				       data, reloc_entry->address,
				       (symbol->value
					+ symbol->section->output_section->vma
...
static bfd_reloc_status_type
nios2_elf32_hiadj20_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			      void *data, asection *input_section,
			      bfd *output_bfd,
			      char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_elf32_do_hiadj20_relocate (abfd, reloc_entry->howto,
					  input_section,
					  data, reloc_entry->address,
					  (symbol->value
					   +
...
static bfd_reloc_status_type
nios2_elf32_pcrel14_s2_relocate (bfd *abfd, arelent *reloc_entry,
				 asymbol *symbol, void *data,
				 asection *input_section, bfd *output_bfd,
				 char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_elf32_do_pcrel14_s2_relocate (
    abfd, reloc_entry->howto, input_section, data, reloc_entry->address,
    (symbol->value + symbol->section->output_section->vma +
     symbol->section->output_offset),
    reloc_entry->addend);
			    ...
			    bfd *output_bfd, char **msg)
{
  ...
  if ((r =
			   ...
			   nios2_link_info)) == bfd_reloc_ok)
    {
      ...
      if ((signed) relocation < -2048 || (signed) relocation > 2047)
	{
...
static bfd_reloc_status_type
nios2_elf32_do_hi20_relocate (bfd *abfd, reloc_howto_type *howto,
                              asection *input_section ATTRIBUTE_UNUSED,
			      bfd_byte *data, bfd_vma offset,
			      bfd_vma symbol_value, bfd_vma addend)
{
  symbol_value = symbol_value + addend;
  addend = 0;
  symbol_value = (symbol_value >> 12) & 0xfffff;
  return _bfd_final_link_relocate (howto, abfd, input_section,
				   data, offset, symbol_value, addend);
}
...
static bfd_reloc_status_type
nios2_elf32_do_lo12_relocate (bfd *abfd, reloc_howto_type *howto,
			      asection *input_section ATTRIBUTE_UNUSED,
			      bfd_byte *data, bfd_vma offset,
			      bfd_vma symbol_value, bfd_vma addend)
{
  symbol_value = symbol_value + addend;
  addend = 0;
  symbol_value = symbol_value & 0xfff;
  return _bfd_final_link_relocate (howto, abfd, input_section,
				   data, offset, symbol_value, addend);
}
...
static bfd_vma hiadj20(bfd_vma symbol_value)
{
  return
    (((symbol_value >> 12) & 0xfffff) + ((symbol_value >> 11) & 0x01)) & 0xfffff;
}
...
static bfd_reloc_status_type
nios2_elf32_do_hiadj20_relocate (bfd *abfd, reloc_howto_type *howto,
			         asection *input_section ATTRIBUTE_UNUSED,
				 bfd_byte *data, bfd_vma offset,
				 bfd_vma symbol_value, bfd_vma addend)
{
  symbol_value = symbol_value + addend;
  addend = 0;
  symbol_value = hiadj20(symbol_value);
  return _bfd_final_link_relocate (howto, abfd, input_section, data, offset,
				   symbol_value, addend);
}
...
static bfd_reloc_status_type
nios2_elf32_do_pcrel14_s2_relocate (bfd *abfd, reloc_howto_type *howto,
				    asection *input_section ATTRIBUTE_UNUSED,
				    bfd_byte *data, bfd_vma offset,
				    bfd_vma symbol_value, bfd_vma addend)
{
				...
				bfd_vma symbol_value, bfd_vma addend)
{
  ...
  if (((input_section->output_section->vma + input_section->output_offset) & 0xf0000000)
      != ((input_section->output_section->vma + input_section->output_offset + offset) & 0xf0000000))
    return bfd_reloc_overflow;

  symbol_value = symbol_value + addend;
  addend = 0;

  /* bit 27:2 of symbol_value = bit 25:0 of imm26 */
  /* re-encode it as extended imm26 */
  symbol_value = (symbol_value & OP_MASK_IMM26HI) | ((symbol_value & (OP_MASK_IMM26LO << 2)) >> 2);
  ...
  for (rel = relocs; rel < relend; rel++)
      ...
      if (howto != NULL)
	{
	  switch (howto->type)
	    ...
	    case R_NIOS2_HI20:
	      r =
		nios2_elf32_do_hi20_relocate (input_bfd, howto, input_section,
					      contents, rel->r_offset,
					      relocation, rel->r_addend);
	      break;
	    case R_NIOS2_LO12:
              r =
                nios2_elf32_do_lo12_relocate (input_bfd, howto, input_section,
                                              contents, rel->r_offset,
                                              relocation, rel->r_addend);
	      break;
	    ...
	    case R_NIOS2_HIADJ16:
              r =
                nios2_elf32_do_hiadj16_relocate (input_bfd, howto,
                                                 ...
                                                 rel->r_addend);
	      break;
	    case R_NIOS2_HIADJ20:
              r =
                nios2_elf32_do_hiadj20_relocate (input_bfd, howto,
                                                 input_section, contents,
                                                 rel->r_offset, relocation,
                                                 rel->r_addend);
	      break;
		...
		nios2_elf32_do_pcrel16_relocate (input_bfd, howto,
						 ...
						 rel->r_addend);
	      break;
	    case R_NIOS2_PCREL14_S2:
	      r =
		nios2_elf32_do_pcrel14_s2_relocate (input_bfd, howto,
						 input_section, contents,
						 rel->r_offset, relocation,
						 rel->r_addend);
	      break;
	      ...
	      else
		{
		  ...
		  rel->r_addend = 0;
		  if ((signed) relocation < -2048
		      || (signed) relocation > 2047)
		    {
...
{
  return (targ == &bfd_elf32_littlenios2dpx_vec
	  || targ == &bfd_elf32_bignios2dpx_vec);
}
                           ...
                           bfd_vma *valp)
{
  ...
  //ToDo: Verify that is_nios2_elf_target (abfd->xvec) works as expected
  if (sym->st_shndx == SHN_COMMON
      && !info->relocatable
      && sym->st_size <= elf_gp_size (abfd)
      && is_nios2_elf_target (abfd->xvec))
    {
...
/* elf bfd */
#define bfd_elf32_bfd_merge_private_bfd_data	nios2_elf_merge_private_bfd_data
...
#define elf_backend_final_write_processing nios2_final_write_processing
...
#define TARGET_LITTLE_SYM               bfd_elf32_littlenios2dpx_vec
#define TARGET_LITTLE_NAME              "elf32-littlenios2dpx"
#define TARGET_BIG_SYM                  bfd_elf32_bignios2dpx_vec
#define TARGET_BIG_NAME                 "elf32-bignios2dpx"
