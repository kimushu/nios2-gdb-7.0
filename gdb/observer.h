...
/* new_inferior notifications.  */

typedef void (observer_new_inferior_ftype) (int pid);

extern struct observer *observer_attach_new_inferior (observer_new_inferior_ftype *f);
extern void observer_detach_new_inferior (struct observer *observer);
extern void observer_notify_new_inferior (int pid);

/* inferior_exit notifications.  */

typedef void (observer_inferior_exit_ftype) (int pid);
...
extern void observer_notify_inferior_exit (int pid);
