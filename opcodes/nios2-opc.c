...
const struct nios2_reg nios2_builtin_regs[] = {
  ...
  {"r30", 30},			/* breakpoint return address */
  ...
  /* note that if you add an alias to general purpose reg, you must
     increment CTLREGBASE in include/opcode/nios2.h */

  /* control register names */
  {"status", 0},  /* CTLREGBASE == 43 */
  {"estatus", 1},
  {"bstatus", 2},
  {"ienable", 3},
  {"ipending", 4},
...
const struct nios2_opcode nios2_builtin_opcodes[] =
{
   /* name,             args,           args_test     num_args,          match,                  mask,                                   pinfo */
       ...
       {"rdprs",         "t,s,i",        "t,s,i,E",     3,         OP_MATCH_RDPRS,          OP_MASK_IOP,                          0,		        		             	signed_immed16_overflow },
       ...
       {"trap",         "b",             "b,E",            0,      	OP_MATCH_TRAP,          OP_MASK_TRAP,                         0, 									no_overflow },
       ...
       {"wrprs",        "d,s",          "d,s,E",       2,         OP_MATCH_WRPRS,         OP_MASK_RRT|OP_MASK_ROPX|OP_MASK_ROP,   0, 				no_overflow },
